...
public class StartScreen extends ScreenAdapter {private static final float WORLD_WIDTH = 480;
    ...
    public void show(){
        ...
        Gdx.input.setInputProcessor(stage);                                        // INPUT PROCESSOR

        Music background = Gdx.audio.newMusic(Gdx.files.internal("music.wav"));                // MUSIC
        ...
        play.addListener(new ActorGestureListener(){
            public void tap(InputEvent event, float x, float y, int count, int button){
                ...
                game.setScreen(new GameScreen(game));                                         // GESTURE DETECTION
                dispose();
            }
        });
        ...
        Image titleImage = new Image(titleTexture);                                          // IMAGE SETTING
